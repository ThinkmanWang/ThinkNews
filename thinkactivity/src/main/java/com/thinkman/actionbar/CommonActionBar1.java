package com.thinkman.actionbar;
...
import com.thinkman.thinkactivity.R;


/**
 * Common action bar left + center + right
 */
public class CommonActionBar1 extends RelativeLayout implements View.OnClickListener {
    private AppCompatCheckedTextView mTitleCtv;
    private AppCompatCheckedTextView mSubTitleCtv;
    private AppCompatCheckedTextView mLeftCtv;
    private AppCompatCheckedTextView mRightCtv;
    private AppCompatCheckedTextView mLeftOfRightCtv;
    private BGATitlebarDelegate mDelegate;

    public CommonActionBar1(Context context) {
        this(context, null);
    }

    public CommonActionBar1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CommonActionBar1(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View.inflate(context, R.layout.layout_common_actionbar_with_sub_title, this);
        initView();
        setListener();
    ...
    protected void initView() {
        ...
        mSubTitleCtv = getViewById(R.id.ctv_bgatitlebar_sub_title);
        mLeftOfRightCtv = getViewById(R.id.ctv_bgatitlebar_left_of_right);
    }
    ...
    protected void setListener() {
        ...
        mSubTitleCtv.setOnClickListener(this);
        mLeftOfRightCtv.setOnClickListener(this);
    }
    ...
    public void showSubTitleCtv() {
        mSubTitleCtv.setVisibility(VISIBLE);
    }
    ...
    public void setSubTitleText(CharSequence szText) {
        mSubTitleCtv.setText(szText);
        showSubTitleCtv();
    }
    ...
    public void setSubTitleText(@StringRes int resid) {
        setSubTitleText(getResources().getString(resid));
    }
    ...
    public void setRightText(CharSequence text) {
        ...
        mRightCtv.setTextColor(Color.WHITE);
        showRightCtv();
    }
    ...
    public void setLeftOfRightText(@StringRes int resid) {
        setLeftOfRightText(getResources().getString(resid));
    }

    private void setLeftOfRightText(String text) {
        mLeftOfRightCtv.setText(text);
        showLeftOfRightCtv();
    }

    public void setLeftOfRightDrawable(Drawable drawable) {
        drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
        mLeftOfRightCtv.setCompoundDrawables(null, null, drawable, null);
        showLeftOfRightCtv();
    }

    public void showLeftOfRightCtv() {
        mLeftOfRightCtv.setVisibility(VISIBLE);
    }

    public void hiddenLeftOfRightCtv() {
        mLeftOfRightCtv.setVisibility(GONE);
    }
    ...
    public void setLeftOfRightCtvChecked(boolean checked) {
        mLeftOfRightCtv.setChecked(checked);
    }
    ...
    public AppCompatCheckedTextView getLeftOfRightCtv() {
        return mLeftOfRightCtv;
    }
    ...
    public void onClick(View v) {
        if (mDelegate != null) {
            ...
            } else if (id == R.id.ctv_bgatitlebar_left_of_right) {
                mDelegate.onClickLeftOfRightCtv();
            }
        }
    }
    ...
    public static class BGATitlebarDelegate {
        ...
        public void onClickLeftOfRightCtv() {
