...
public class ThinkRecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public ThinkRecyclerViewHolder(View convertView) {
        super(convertView);
     ...
     */
    public void setOnItemClickListener(final ThinkRecyclerViewHolder.OnItemClickListener listener, final int position) {
        if (listener == null) {
     ...
     * @param position position
     */
    public void setOnItemLongClickListener(final ThinkRecyclerViewHolder.OnItemLongClickListener listener, final int position) {
        if (listener == null) {
