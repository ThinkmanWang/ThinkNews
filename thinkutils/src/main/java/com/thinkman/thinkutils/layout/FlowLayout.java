    ...
    public FlowLayout(Context context, AttributeSet attrs) {
        ...
        try {
            mHorizontalSpacing = a.getDimensionPixelSize(
                    R.styleable.FlowLayout_horizontal_spacing, DisplayUtil.dip2px(context, DEFAULT_HORIZONTAL_SPACING));
            mVerticalSpacing = a.getDimensionPixelSize(
                    R.styleable.FlowLayout_vertical_spacing, DisplayUtil.dip2px(context, DEFAULT_VERTICAL_SPACING));
        } finally {
            a.recycle();
        }
    }
