package com.thinkman.thinkutils.listener;
...
//        mSwipeListener = listener;
    ...
    public RecyclerViewTouchListener setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public RecyclerViewTouchListener setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public RecyclerViewTouchListener setUnClickableRows(Integer... rows) {
    ...
    public RecyclerViewTouchListener setLeftToRightSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
    ...
    public RecyclerViewTouchListener setSwipeable(boolean value) {
    ...
    private void animateFadeViews(View downView, float alpha, long duration) {
        if (fadeViews != null) {
            for (final int viewID : fadeViews) {
                View view = downView.findViewById(viewID);
