...
public class PasswordView extends AppCompatEditText {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            this.iconPosition = IconPosition.values()[typedArray.getInteger(R.styleable.PasswordView_iconPosition, IconPosition.RIGHT.ordinal())];
            this.showPasswordIcon = typedArray.getResourceId(R.styleable.PasswordView_showPasswordIcon, R.drawable.ic_eye);
            this.hidePasswordIcon = typedArray.getResourceId(R.styleable.PasswordView_hidePasswordIcon, R.drawable.ic_eye_strike);

            String path = typedArray.getString(R.styleable.PasswordView_fontPath);
//            if (path != null) {
