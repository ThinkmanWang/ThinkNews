...
package com.thinkman.thinkutils.view.decorator;
...
public class ThinkDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public ThinkDividerItemDecoration(Context context, int orientation) {
        this.setDefaultDivider(context);
        this.setOrientation(orientation);
    }


    public ThinkDividerItemDecoration(Activity activity, int orientation, int drawableId) {
